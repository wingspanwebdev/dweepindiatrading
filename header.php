...
<head>
    <meta charset="utf-8">
    <title>Dweep India Trading</title>
                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <a href="company_profile.php" class="dropdown-item">Company Profile</a>
                        ...
                        <!-- <li class="nav-item dropdown has-megamenu">
                            ...
                            <div class="dropdown-menu megamenu" role="menu">
                                <div class="row w-100 g-3 mx-auto">
                                    <div class="col-lg-2 col-6">
                                        <div class="col-megamenu">
                                            <h5 class="title">Oil Seeds</h5>
                                            <ul class="list-unstyled">
                                                <li><a href="#">Java peanuts </a></li>
                                                <li><a href="#">TJ peanuts</a></li>
                                                <li><a href="#">Bold peanuts</a></li>
                                                <li><a href="#">Blanched peanuts</a></li>
                                                <li><a href="#">Hulled sesame seeds</a></li>
                                                <li><a href="#">Natural sesame seeds</a></li>
                                                <li><a href="#">Mustard seeds</a></li>
                                                <li><a href="#">Watermelon seeds</a></li>
                                                <li><a href="#">Flax seeds</a></li>
                                                <li><a href="#">Chia seeds</a></li>
                                                <li><a href="#">Sabja seeds</a></li>
                                            </ul>
                                        </div> 
                                    </div>
                                    <div class="col-lg-2 col-6">
                                        <div class="col-megamenu">
                                            <h5 class="title">Spices</h5>
                                            <ul class="list-unstyled">
                                                <li><a href="#">Cumin seeds</a></li>
                                                <li><a href="#">Fenugreek seeds</a></li>
                                                <li><a href="#">Fennel seeds</a></li>
                                                <li><a href="#">Coriander seeds</a></li>
                                                <li><a href="#">Turmeric whole</a></li>
                                                <li><a href="#">Red chillies</a></li>
                                                <li><a href="#">Dry ginger</a></li>
                                                <li><a href="#">Black pepper</a></li>
                                                <li><a href="#">Cardamom</a></li>
                                                <li><a href="#">Carom seeds</a></li>
                                                <li><a href="#">Nutmeg</a></li>
                                                <li><a href="#">Mace</a></li>
                                                <li><a href="#">Bay leaf</a></li>
                                                <li><a href="#">Caraway seeds</a></li>
                                                <li><a href="#">Black cumin</a></li>
                                                <li><a href="#">Cinnamon</a></li>
                                                <li><a href="#">Black cardamom</a></li>
                                                <li><a href="#">Cloves</a></li>
                                            </ul>
                                    </div>
                                    <div class="col-lg-2 col-6">
                                        <div class="col-megamenu">
                                            <h5 class="title">Powders</h5>
                                            <ul class="list-unstyled">
                                                <li><a href="#">Red chillies</a></li>
                                                <li><a href="#">Turmeric</a></li>
                                                <li><a href="#">Coriander seeds</a></li>
                                                <li><a href="#">Dry ginger</a></li>
                                                <li><a href="#">Amchur</a></li>
                                                <li><a href="#">Garam masala</a></li>
                                                <li><a href="#">Pav bhaji masasla</a></li>
                                                <li><a href="#">Sambhar masala</a></li>
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <div class="col-megamenu">
                                            <h5 class="title">Dehydrated Items</h5>
                                            <ul class="list-unstyled">
                                                <li><a href="#">Dehydrated onions chopped, minced and powder</a></li>
                                                <li><a href="#">Dehydrated garlic chopped, minced and powder</a></li>
                                                <li><a href="#">Banana powder</a></li>
                                                <li><a href="#">Cucumber powder</a></li>
                                                <li><a href="#">Kiwi mango black current strawberry amla cranberry pineapples ginger cherry blueberry apricots blackcurrant</a></li>
                                            </ul>
                                        </div> 
                                    </div>
                                    <div class="col-lg-2 col-12">
                                        <div class="col-megamenu">
                                            <h5 class="title">Pulses and Grain</h5>
                                            <ul class="list-unstyled">
                                                <li><a href="#">Green milleta</a></li>
                                                <li><a href="#">Channa dal</a></li>
                                                <li><a href="#">Checkpeas</a></li>
                                                <li><a href="#">Desi chana</a></li>
                                                <li><a href="#">Guar gam powder</a></li>
                                            </ul>
                                        </div> 
                                    </div>
                                </div>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu menu-main bg-light rounded-0 m-0">
